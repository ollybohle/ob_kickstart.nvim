...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>a', "<cmd>lua require('harpoon.mark').add_file()<cr>", opts) -- add file to harpoon
      vim.keymap.set('n', '<C-e>a', "<cmd>lua require('harpoon.ui').toggle_quick_menu()<CR>", opts) -- open harpoon menu
